    ...
    constructor(){
        ...
        this.state = {
            buku: [
                ...
                {
                    isbn:"78954", judul:"Anak Pemberani", penulis:"Tere Liye",
                    penerbit:"CV Nusa Bangsa", harga: 70000,
                    cover:"https://inc.mizanstore.com/aassets/img/com_cart/produk/si-anak-pemberani-recovertere-liye.JPG"
                },
                {
                    isbn:"22543", judul:"Pulang", penulis:"Tere Liye",
                    penerbit:"CV Harapan Opet", harga: 80000,
                    cover:"https://inc.mizanstore.com/aassets/img/com_cart/produk/pulang-tere-liye.jpg"
                },
                {
                    isbn:"77543", judul:"Pergi", penulis:"Tere Liye",
                    penerbit:"CV Harapan Opet", harga: 80000,
                    cover:"https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1522123452i/39643727.jpg"
                },
 ...
 searching = event => {
  ...
  addToCart = (selectedItem) => {
      ...
      render(){
        ...
        <button className="btn btn-light" onClick={() => this.add()}><strong>Tambah Data</strong></button>
